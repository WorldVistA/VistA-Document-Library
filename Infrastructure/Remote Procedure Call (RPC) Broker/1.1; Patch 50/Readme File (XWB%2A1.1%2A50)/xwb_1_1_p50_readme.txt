...
C:\Program Files (x86)\Vista directory.
  ...
  3. After installing the zip file, there should be a BDK32 directory with the following
     subdirectories: 
       ...
       Help            - The help files distributed with XWB*1.1*50 BDK have been
                         replaced by contains Broker help files. See the updated RPC Broker
                         Installation Guide (XWB1_1_IG.pdf) for instructions on how to install
                         the updated help files.
